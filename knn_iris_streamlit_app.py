...
if st.session_state.page == "welcome":
    ...
    with col1:
        ...
        st.image(img_bytes, caption="Iris Setosa", use_container_width=True)
        st.markdown("**Setosa** 🌱\n\n- Small and delicate.\n- Short petals and sepals.\n- Typically found in cooler climates.")

    with col2:
        img_bytes = load_image_bytes(versicolor_img)
        st.image(img_bytes, caption="Iris Versicolor", use_container_width=True)
    ...
    with col3:
        ...
        st.image(img_bytes, caption="Iris Virginica", use_container_width=True)
